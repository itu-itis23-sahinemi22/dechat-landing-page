...
export const t = {
  tr: {
    ...
    contact: {
      pageTitle: 'Erken Erişim',
      subtitle: 'İlk kullananlar arasında ol. E-posta adresini bırak, hazır olduğunda haber verelim.',
      emailLabel: 'E-posta',
      ...
      form: {
        ...
        submit: 'Kaydol',
        successMsg: 'Kaydın alındı! En kısa sürede haber vereceğiz.',
      },
    },
    footer: {
  ...
  en: {
    ...
    contact: {
      ...
      subtitle: "Be among the first. Leave your email and we'll notify you when ready.",
      emailLabel: 'Email',
      ...
      form: {
        ...
        submit: 'Sign Up',
        successMsg: "You're on the list! We'll be in touch soon.",
      },
    },
    footer: {
